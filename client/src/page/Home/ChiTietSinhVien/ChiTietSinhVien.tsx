                ...
                <div className="ChiTietSinhVien_my-info">
                    ...
                    <div>
                        ...
                        <div className="ChiTietSinhVien_container">
                            <div className="ChiTietSinhVien_text-info">
                                <ul>
                                    <li>Ngày Sinh: <b>{data.data.ThongTinCaNhan.ngaySinh}</b></li>
                                    <li>Số CMND: <b>{data.data.ThongTinCaNhan.CMND.soCMND} </b></li>
                                    <li>Đối tượng;</li>
                                    <li>Ngày vào đoàn:</li>
                                    <li>SĐT : <b>{data.data.ThongTinCaNhan.SDT}</b></li>
                                </ul>
                            </div>
                            <div className="ChiTietSinhVien_text-info">
                                <ul>
                                    <li>Dân tộc: <b>{data.data.ThongTinCaNhan.danToc}</b></li>
                                    <li>Ngày cấp:</li>
                                    <li>Diện danh sách</li>
                                    <li>Ngày vào Đảng</li>
                                    <li>Email: <b>{data.data.ThongTinCaNhan.email}</b></li>
                                </ul>
                            </div>
                            <div className="ChiTietSinhVien_text-info">
                                <ul>
                                    <li>Tôn Giáo: <b>{data.data.ThongTinCaNhan.tonGiao}</b></li>
                                    <li>Nơi cấp</li>
                                </ul>
                            </div>
                            <div className="ChiTietSinhVien_text-info">
